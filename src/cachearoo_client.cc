      ...
      try {
        ...
        if (item->options.method == "GET") {
          if (item->options.key.empty()) {
            // List operation
            auto list_result = connection_->List(item->options.bucket.value_or(settings_.bucket),
                                                 item->options.keys_only,
                                                 item->options.filter.value_or(""));
          ...
          // Write operation
          result = connection_->Write(item->options.bucket.value_or(settings_.bucket),
                                    item->options.key,
                                    item->options.data.value_or("{}"),
                                    item->options.fail_if_exists,
          ...
          // Delete operation
          connection_->Delete(item->options.bucket.value_or(settings_.bucket),
                            item->options.key);
